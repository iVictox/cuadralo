...
export default function RegisterPage() {
  ...
  const handleFinalSubmit = () => {
      // AQUÍ ENVIARÍAS TODO 'formData' AL BACKEND
  ...
  return (
    <div className="min-h-screen w-full bg-[#0f0518] flex items-center justify-center relative overflow-hidden py-10">
      ...
      >
        ...
        <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 shadow-2xl relative overflow-hidden min-h-[500px] flex flex-col">
            
            {/* Botón Atrás (Si no estamos en el paso 0) */}
            {step > 0 && (
                ...
                {step === 5 && (
                    ...
                    >
                        ...
                        <button 
                            ...
                            className="w-full bg-gradient-to-r from-cuadralo-pink to-cuadralo-purple py-4 rounded-xl font-bold text-white text-lg shadow-xl hover:scale-[1.02] transition-all flex items-center justify-center gap-2"
                        >
