        ...
        <div className="p-1">
            {isMe ? (
                ...
                <button
                    ...
                    disabled={isViewed}
                    className={`w-[200px] h-[250px] rounded-2xl flex flex-col items-center justify-center gap-3 transition-all ${isViewed ? "bg-black/5 dark:bg-gray-800 opacity-50" : "bg-cuadralo-pink/10 hover:bg-cuadralo-pink/20"
                        }`}
                >
...
export default function ChatWindow({ chat, onBack }) {
    ...
    const { checkIsOnline, markChatAsRead } = useSocket(); // ✅ EXTRAEMOS FUNCIÓN
    ...
    // ✅ NUEVO: Marcar como leídos los mensajes si los recibimos mientras estamos en el chat
    useEffect(() => {
    ...
    // ✅ NUEVO: Escuchar cuando el otro usuario lee nuestros mensajes (Check azul instantáneo)
    useEffect(() => {
