  ...
  return (
    <div className="fixed inset-0 z-[60] flex flex-col justify-end sm:justify-center sm:items-center bg-black/60 backdrop-blur-sm" onClick={onClose}>
        ...
        <motion.div 
            ...
            className="w-full sm:w-[450px] h-[80vh] sm:h-[600px] bg-[#1a0b2e] border-t sm:border border-white/10 sm:rounded-3xl flex flex-col shadow-2xl relative overflow-hidden"
        >
            <div className="p-4 border-b border-white/10 flex justify-between items-center bg-[#0f0518]">
                <div><h3 className="text-white font-bold text-lg">Comentarios</h3><p className="text-xs text-gray-400">Post de {postAuthor}</p></div>
