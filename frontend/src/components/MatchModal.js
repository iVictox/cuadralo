...
export default function MatchModal({ matchedUser, onClose, onChat }) {
  // INICIALIZACIÓN SEGURA: Usamos la imagen por defecto desde el principio
  ...
  useEffect(() => {
    try {
      ...
      if (userStr) {
        ...
        // Solo actualizamos si el usuario tiene una foto real (no string vacío)
  ...
  // Asegurarnos de que la foto del otro usuario tampoco esté vacía
  const matchedUserPhoto = matchedUser.img || DEFAULT_IMG;

  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/90 backdrop-blur-xl p-4">
      
      {/* Fondo de Confeti (Efecto visual) */}
      ...
      >
        {/* Título con Texto Gradiente y Animado */}
        <motion.h1 
        ...
        <div className="flex justify-center items-center gap-4 mb-12 relative h-40 w-full">
            ...
            >
                {/* Usamos myPhoto que ya está garantizado que NO es vacío */}
